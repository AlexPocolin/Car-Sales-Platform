    ...
    <div class="adminDasboard flex">
        ...
        <div class="todoBody">
            <div class="top flex">
                ...
                <a href="addTodoS.php"><button  class="flex btn bg">
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                ...
                                <div class="singleTodo">
                                    <div class="flex">
                                        ...
                                        <div class="btns">
                                        <a href="<?php echo SITEURL?>View/Backend/Admin/updateTodoS.php?id=<?php echo $id?>">
                                            <i class="uil uil-edit icon"></i>
                                        </a>
                                        <a href="<?php echo SITEURL?>View/Backend/Admin/deleteTodoS.php?id=<?php echo $id?>">
            ...
            <div class="notesDiv">
                <div class="top notesTitle flex">
                    ...
                    <a href="addNoteS.php"><button  class="flex btn bg">
                        <i class="uil uil-plus"></i> Add New
                    </button></a>
                </div>
                                ...
                                while($row = mysqli_fetch_assoc($res)){
                                    ...
                                    <div class="singleNote">
                                        <div class="flex">
                                            <span><?php echo $date?></span>
                                            <div class="btns">
                                                <a href="<?php echo SITEURL?>View/Backend/Admin/updateNoteS.php?id=<?php echo $id?>">
                                                    <i class="uil uil-edit icon"></i>
                                                </a>
                                                <a href="<?php echo SITEURL?>View/Backend/Admin/deleteNoteS.php?id=<?php echo $id?>">
                                                    <i class="uil uil-trash-alt icon"></i>
                                                </a>
                                            </div>
                                        </div>
